...
**Full Name:** Sirine Asmar

**GitHub Username:** sirine536
...
A Next.js 16 project built using the App Router.
The project includes static data files, dynamic routes, nested routes, shared layouts, and reusable components.
